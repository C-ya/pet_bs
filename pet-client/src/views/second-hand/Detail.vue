...
export default {
  ...
  methods: {
    ...
    updateStatus() {
      this.$axios
        .get("/api/second-hand/updateStatus?id=" + this.secondHand.id)
        .then((res) => {
          let result = res.data;
          if (result.success) {
