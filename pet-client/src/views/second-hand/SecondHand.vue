  ...
  <div class="container">
    ...
    <Row class="second-hand-menu">
      <iCol class="second-hand-category" span="15">
        ...
        <a
          is="sui-label"
          v-if="activeSecondHandCategory === '我的'"
          color="orange"
          @click="selectCategory('我的')"
          >我的</a
        >
    ...
    <div class="second-hand-list">
      ...
      >
        ...
        <sui-card-content>
          ...
          <!--              </a>-->
          <!--            </span>-->
          <span class="second-hand-price" v-if="secondHand.state == 0"
            >待审核</span
          >
        </sui-card-content>
      ...
      <Form :model="secondHanAddModal.form" :label-width="50">
        ...
        <FormItem label="描述" required>
          <Input
            ...
            placeholder="输入描述信息，有助于管理审核，如：宠物性格、注意事项、是否驱虫、寄养要求等。"
          />
        </FormItem>
